  ...
  return (
    <div className="flex justify-center items-center min-h-screen">
      <div className="bg-white py-4 px-6 text-gray-800 rounded-lg flex flex-col w-sm">
        <p className="text-center text font-medium mb-4">Register</p>
        <form className="text-sm flex flex-col space-y-4" onSubmit={handleSubmit}>
          ...
          <button className="my-2 w-full bg-black text-white px-4 py-2 rounded-lg hover:bg-black/90 text-sm">Register</button>
        </form>
      </div>
    </div>
  );
